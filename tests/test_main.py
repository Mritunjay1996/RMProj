...
#     hospUser_obj.select_cancelRotations_no()
...
#     assert hospUser_obj.verify_cancelRotations_no() == True, \
#         "Cancel Rotations: Yes is wrong for the created Hospital User. Instead it should be No"
...
#     register_page.selectSchoolCampusDiscipline("ASA College2 - Miami2 - Nursing")
...
#     my_account.enter_cuurent_password(student_credit_password)
#     my_account.enter_new_password("Password2")
#     time.sleep(2)
...
#     assert "green.png" in schoolfiles_page.validateSuccessfulUpload(), "Uploading the file failed."
#
# ### To-Do : Placeholder for Use Case S6
#
# ### To-Do : Placeholder for Use Case S7
#
# ### To-Do : Placeholder for Use Case S8
#
...
#     help_page.enter_message('This is a test message created by Automation')
...
def test_hospital_declines_rotation(browser):
    gmail_page = gmailPage(browser)
    gmail_page.open_mailbox("hospital.user.email123456")
